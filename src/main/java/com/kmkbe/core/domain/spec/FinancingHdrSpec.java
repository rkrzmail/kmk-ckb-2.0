...
public class FinancingHdrSpec {
    ...
    public static Specification<FinancingHdr> byDisbursement(String searchBy, String value) {
        return (root, query, criteriaBuilder) -> {
            Join<FinancingHdr,Agreement> joinAgreement = root.join("financing_hdr_code", JoinType.INNER);
            Join<Agreement, DisbursementLog> joinDisbursement = joinAgreement.join("agreement_code", JoinType.INNER);


            return joinDisbursement.in(byStepStatus(searchBy, value));
        };
    }

//    public static Specification<FinancingHdr> byDisbursementStepStatus(String searchBy, String value) {
//        return byDisbursement()
//                .and(byStepStatus(searchBy, value));
//    }
}
